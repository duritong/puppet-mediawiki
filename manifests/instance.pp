...
define mediawiki::instance(
  ...
  if ($ensure == 'absent') {
    ...
    mediawiki::file{
      [ "${real_path}/languages", "${real_path}/php5.php", "${real_path}/thumb.php", "${real_path}/img_auth.php",
        ...
        "${real_path}/serialized", "${real_path}/StartProfiler.php", "${real_path}/trackback.php" ]:
      src_path => $basedir,
    }
