class mediawiki::base {
  ...
  file{'/opt/bin/mediawiki_dbupdate.config.rb':
    source => [ "puppet://$server/modules/site-mediawiki/updatescript/${fqdn}/mediawiki_dbupdate.config.rb",
                "puppet://$server/modules/site-mediawiki/updatescript/mediawiki_dbupdate.config.rb",
